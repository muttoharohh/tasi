              ...
              <form action="<?php echo base_url('login')?>" method="post" onsubmit="return cekform();">
                ...
                <div class="form-group">
                  <div class="input-group">
                    <input type="email" id="email" name='email' value="<?php echo set_value('email'); ?>" class="form-control" placeholder="...@student.itera.ac.id" required>
                ...
                <div class="form-group">
                  <div class="input-group">
                    <input type="password" id="password_conf" name='password_conf' value="<?php echo set_value('password_conf'); ?>" class="form-control" placeholder="Confirm Password" required>
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline"></i>
                      </span>
